...
export type User = Actor & Node & PackageOwner & ProfileOwner & ProjectNextOwner & ProjectOwner & RepositoryDiscussionAuthor & RepositoryDiscussionCommentAuthor & RepositoryOwner & Sponsorable & UniformResourceLocatable & {
  ...
  issues: IssueConnection;
  issuesEndCursor?: Maybe<Scalars['String']>;
  issuesFeed?: Maybe<Array<Maybe<Issue>>>;
  issuesHasNextPage?: Maybe<Scalars['Boolean']>;
...
export type Cache_UserInfo_ViewerPropsQuery = { __typename?: 'Query', viewer: { __typename?: 'User', login: string, avatarUrl: any, name?: string | null | undefined, location?: string | null | undefined, twitterUsername?: string | null | undefined, bio?: string | null | undefined, libraryRepoId?: string | null | undefined, currentOid?: string | null | undefined, stargazerCount?: number | null | undefined, issuesTotalCount?: number | null | undefined, issuesHasNextPage?: boolean | null | undefined, issuesEndCursor?: string | null | undefined, followingUsers?: Array<string> | null | undefined, followingTags?: Array<string> | null | undefined, saved?: Array<string> | null | undefined, issuesFeed?: Array<{ __typename?: 'Issue', id: string, number: number, title: string, bodyText: string, bodyUrl: any, reactions: { __typename?: 'ReactionConnection', totalCount: number }, comments: { __typename?: 'IssueCommentConnection', totalCount: number } } | null | undefined> | null | undefined } };

export type Cache_UserInfo_UserPropsFragment = { __typename?: 'User', login: string, avatarUrl: any, name?: string | null | undefined, location?: string | null | undefined, twitterUsername?: string | null | undefined, bio?: string | null | undefined, stargazerCount?: number | null | undefined, issuesTotalCount?: number | null | undefined, issuesHasNextPage?: boolean | null | undefined, issuesEndCursor?: string | null | undefined, followingUsers?: Array<string> | null | undefined, hasBeen?: UserHasBeen | null | undefined, fullyLoaded?: boolean | null | undefined, issuesFeed?: Array<{ __typename?: 'Issue', id: string, number: number, title: string, bodyText: string, bodyUrl: any, reactions: { __typename?: 'ReactionConnection', totalCount: number }, comments: { __typename?: 'IssueCommentConnection', totalCount: number } } | null | undefined> | null | undefined };
...
export type Frag_User_FieldsFragment = { __typename?: 'User', id: string, login: string, avatarUrl: any, name?: string | null | undefined, location?: string | null | undefined, twitterUsername?: string | null | undefined, bio?: string | null | undefined, libraryRepoId?: string | null | undefined, currentOid?: string | null | undefined, stargazerCount?: number | null | undefined, issuesTotalCount?: number | null | undefined, followingUsers?: Array<string> | null | undefined, followingTags?: Array<string> | null | undefined, issuesHasNextPage?: boolean | null | undefined, issuesEndCursor?: string | null | undefined, saved?: Array<string> | null | undefined, hasBeen?: UserHasBeen | null | undefined, fullyLoaded?: boolean | null | undefined, issuesFeed?: Array<{ __typename?: 'Issue', id: string, number: number, title: string, bodyText: string, bodyUrl: any, reactions: { __typename?: 'ReactionConnection', totalCount: number }, comments: { __typename?: 'IssueCommentConnection', totalCount: number } } | null | undefined> | null | undefined };
...
export const GetViewerGitstagramLibraryDocument = gql`
    query GetViewerGitstagramLibrary($afterIssueCursor: String, $repositoryName: String = "gitstagram-library", $firstIssues: Int = 21, $filterIssuesStates: [IssueState!] = OPEN, $userLogin: String!) {
  viewer {
    ...FRAG_User_Fields
    repository(name: $repositoryName) {
      ...PART_Repository_With_Issues
...
export const GetUserGitstagramLibraryDocument = gql`
    query GetUserGitstagramLibrary($afterIssueCursor: String, $userLogin: String!, $repositoryName: String = "gitstagram-library", $firstIssues: Int = 21, $filterIssuesStates: [IssueState!] = OPEN) {
